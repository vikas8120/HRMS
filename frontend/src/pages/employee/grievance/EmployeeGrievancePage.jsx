...
function EmployeeGrievancePage() {
  const { user } = useAuth()
  ...
  const [form, setForm] = useState(createForm(resolveEmployeeContext(user), ''))
  ...
  const openNew = () => {
    ...
    setEditingId('')
    setForm(createForm(employeeCtx, grievanceNo))
    setFormOpen(true)
  }
  ...
  return (
    <section className="section-layout">
      <PageHeader
        ...
        description="Raise and track your grievances with status updates."
        breadcrumb={['Employee Portal', 'Grievance']}
        primaryActionLabel="Raise New Grievance"
      ...
      <div className="panel">
        <div className="panel-head"><h3>My Grievances</h3></div>
...
export default EmployeeGrievancePage
