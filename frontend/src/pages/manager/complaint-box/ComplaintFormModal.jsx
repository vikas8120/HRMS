      ...
      <div className="modal-form company-form-modal">
        <div className="company-form-section">
          <div className="company-form-section-head">
            ...
            <p>Core complaint details and reporting identifiers.</p>
          </div>
        ...
        <div className="company-form-section">
          <div className="company-form-section-head">
            ...
            <p>Enter subject, category and supporting evidence.</p>
          </div>
          <div className="form-grid company-form-grid">
        ...
        <div className="company-form-section">
          <div className="company-form-section-head">
            <h4>Review & Closure</h4>
            <p>Severity, confidentiality and resolution status overview.</p>
          </div>
          <div className="form-grid company-form-grid">
